...
public class ClassTestDescriptor extends JupiterTestDescriptor {
	...
	public JupiterEngineExecutionContext prepare(JupiterEngineExecutionContext context) {
		...
		boolean requireStatic = extensionContext.getTestInstanceLifecycle().orElse(
			Lifecycle.PER_METHOD) == Lifecycle.PER_METHOD;

		this.beforeAllMethods = findBeforeAllMethods(this.testClass, requireStatic);
		this.afterAllMethods = findAfterAllMethods(this.testClass, requireStatic);
